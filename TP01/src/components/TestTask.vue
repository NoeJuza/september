...
let workspace = {
    ...
    iconColor: "color",
    taskList: [
        { id: 1, name: 'Task 1', state: 'to-do', description: 'Description 1', date: '2023-06-01', notif: true, whenNotif: '2023-06-01', priority: 'High', taskType: 'Work' },
    ...
    editTask: (id,newDatas) =>{
        this.taskList[this.taskList.find(x => x,id == id).id] = newDatas
    },
    removeTask: (id)=>{
        this.taskList.filter(x => x.id != id)
    }
};
</script>
